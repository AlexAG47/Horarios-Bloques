...
<body>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $origen_modal = "'Usuarios'"; //Se refiere a quien pertenece el proceso anterior (Profesores, Materias, etc.) 
                        require('../Funciones/Php/Func_Usuarios/Mos_usua.php');
                    ?>               
                </tbody> 
            </table>
        </div>  
    ...
    <script>insertaTitulo(<?php echo "'Usuarios'" ?>);</script>
