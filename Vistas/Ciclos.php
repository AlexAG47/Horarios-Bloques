...
<body>
            ...
            <table class="table table-hover">
                <thead>
                    <tr class="table-primary">
                        ...
                        <th scope="col">AÑO</th>
                        <th scope="col">DESCRIPCION DE CICLO</th>
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $origen_modal = "'Ciclos'"; //Se refiere a quien pertenece el proceso anterior (Profesores, Materias, etc.) 
                        require('../Funciones/Php/Func_Ciclos/Mos_ciclo.php');
                    ?>               
                </tbody> 
            </table>
        </div>  
    ...
    <script>insertaTitulo(<?php echo "'Ciclos'" ?>);</script>
