...
<body>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $origen_modal = "'Materias'"; //Se refiere a quien pertenece el proceso anterior (Profesores, Materias, etc.) 
                        require('../Funciones/Php/Func_Materias/Mos_mate.php');
                    ?>               
                </tbody> 
            </table>
        </div>  
    ...
    <script>insertaTitulo(<?php echo "'Materias'" ?>);</script>
