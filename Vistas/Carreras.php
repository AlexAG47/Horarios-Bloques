...
<body>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $origen_modal = "'Carreras'"; //Se refiere a quien pertenece el proceso anterior (Profesores, Materias, etc.) 
                        require('../Funciones/Php/Func_Carreras/Mos_carre.php');
                    ?>               
                </tbody> 
            </table>
        </div>  
    ...
    <script>insertaTitulo(<?php echo "'Carreras'" ?>);</script>
