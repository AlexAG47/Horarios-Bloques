...
<form method="POST" action="../Funciones/Php/Func_profesores/Eli_prof.php"> 
    <div class="alert alert-danger d-flex align-items-center" role="alert">
        ...
        <div>
            ...
            ¿Esta seguro de <strong>ELIMINAR</strong> este profesor? <br>
            <strong>    
                    <?php echo $row['ap_paterno'].' '.$row['ap_materno'].' '.$row['nombre'];?>              
            </strong>    
